...
public interface WebhooksService {
   ...
   * @return Confirm webhook result.
   */
  ConfirmWebhookResponse confirm(String webhookUrl, RequestOptions<ConfirmWebhookRequest> options);
   ...
   * @return Confirm webhook result.
   */
  ConfirmWebhookResponse confirm(
