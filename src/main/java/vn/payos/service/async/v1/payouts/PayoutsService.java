...
public interface PayoutsService {
   ...
   * @return Payout detail.
   */
  CompletableFuture<Payout> create(PayoutRequests payoutData);
   ...
   * @return Payout detail.
   */
  CompletableFuture<Payout> get(String payoutId);
   ...
   */
  CompletableFuture<EstimateCredit> estimateCredit(
      PayoutRequests payoutData, RequestOptions<PayoutRequests> options);
   ...
   * @return The estimate result.
   */
  CompletableFuture<EstimateCredit> estimateCredit(PayoutBatchRequest payoutData);
   ...
   * @param options Additional options.
   * @return The payouts detail.
   */
  CompletableFuture<PageAsync<Payout>> list(
   ...
   * @return The payouts detail.
   */
  CompletableFuture<PageAsync<Payout>> list(GetPayoutListParams params);
