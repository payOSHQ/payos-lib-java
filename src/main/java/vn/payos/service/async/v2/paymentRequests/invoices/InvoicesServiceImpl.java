...
/** InvoicesServiceImpl */
public class InvoicesServiceImpl extends APIService<PayOSAsync> implements InvoicesService {
  /**
   * InvoicesServiceImpl
   *
   * @param client client
   */
  public InvoicesServiceImpl(PayOSAsync client) {
    super(client);
  }

  @Override
  public CompletableFuture<InvoicesInfo> get(String paymentLinkId, RequestOptions<Void> options) {
    ...
    return client.getAsync(
        "/v2/payment-requests/" + paymentLinkId, InvoicesInfo.class, requestOptions);
  }

  @Override
  public CompletableFuture<InvoicesInfo> get(Long orderCode, RequestOptions<Void> options) {
    ...
    return client.getAsync("/v2/payment-requests/" + orderCode, InvoicesInfo.class, requestOptions);
  }

  @Override
  public CompletableFuture<InvoicesInfo> get(String paymentLinkId) {
    return this.get(paymentLinkId, null);
  }

  @Override
  public CompletableFuture<InvoicesInfo> get(Long orderCode) {
    return this.get(orderCode, null);
  }

  @Override
  public CompletableFuture<FileDownloadResponse> download(
    ...
    return this.client.downloadFileAsync(
  ...
  @Override
  public CompletableFuture<FileDownloadResponse> download(String invoiceId, String paymentLinkId) {
    return this.download(invoiceId, paymentLinkId, null);
  }

  @Override
  public CompletableFuture<FileDownloadResponse> download(String invoiceId, Long orderCode) {
