...
import vn.payos.service.blocking.v2.paymentRequests.invoices.InvoicesServiceImpl;
import vn.payos.util.SafeNumberUtils;

/** PaymentRequestsServiceImpl */
public class PaymentRequestsServiceImpl extends APIService<PayOS>
   ...
   * @param client client
   */
  public PaymentRequestsServiceImpl(PayOS client) {
    super(client);
  }
  ...
  public CreatePaymentLinkResponse create(
    ...
    return client.post("/v2/payment-requests", CreatePaymentLinkResponse.class, requestOptions);
  }

  @Override
  public CreatePaymentLinkResponse create(CreatePaymentLinkRequest paymentData) {
    return create(paymentData, null);
  }

  @Override
  public PaymentLink get(String paymentLinkId, RequestOptions<Void> options) {
    ...
    return client.get("/v2/payment-requests/" + paymentLinkId, PaymentLink.class, requestOptions);
  }
  ...
  @Override
  public PaymentLink get(Long orderCode, RequestOptions<Void> options) {
    ...
    return client.get("/v2/payment-requests/" + orderCode, PaymentLink.class, requestOptions);
  }
  ...
  @Override
  public PaymentLink cancel(String paymentLinkId, String cancellationReason) {
  ...
  @Override
  public PaymentLink cancel(Long orderCode, String cancellationReason) {
    return cancel(orderCode, cancellationReason, null);
  }

  @Override
  public PaymentLink cancel(Long orderCode) {
